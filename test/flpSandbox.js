		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Mrutyunjaya&#x27;s Portfolio",
									"targetURL": "#porportfolio-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"porportfolio-display": {
								"semanticObject": "porportfolio",
								"action": "display",
								"description": "Mrutyunjaya&#x27;s Portfolio",
								"title": "Mrutyunjaya&#x27;s Portfolio",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=por.portfolio",
									"url": sap.ui.require.toUrl("por/portfolio")
								}
							}
						}
					}
